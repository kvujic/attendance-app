    ...
    <table class="correction-list__table">
        ...
        <tbody>
            ...
            <tr class="correction-list__table-row body-row">
                ...
                <td class="correction-list__data">{{ $correction->target_date ?? '-' }}</td>
                ...
                <td class="correction-list__data">
                    ...
                    <a href="{{ route('stamp_correction_request.showCorrection', ['correction' => $correction->id]) }}" class="detail-link">詳細</a>
                    @else
                    -
                    @endif
                </td>
