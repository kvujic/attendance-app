...
<div class="correction-list__container">
    ...
    <div class="border">
        <ul class="tab-nav">
            <li class="tab-menu"><a href="{{ route('stamp_correction_request.index', ['tab'=>'pending']) }}" class="tab-link {{ $tab === 'pending' ? 'active' : '' }}">承認待ち</a></li>
            <li class="tab-menu"><a href="{{ route('stamp_correction_request.index', ['tab'=>'approved']) }}" class="tab-link {{ $tab === 'approved' ? 'active' : '' }}">承認済み</a></li>
        </ul>
    </div>
    ...
    <table class="correction-list__table">
        ...
        <tbody>
            ...
            <tr class="correction-list__table-row body-row">
                <td class="correction-list__data">{{ $correction->status_label }}</td>
            ...
            <tr class="correction-list__table-row">
                <td class="correction-list__data">申請はありません</td>
            </tr>
            @endforelse
        </tbody>
    </table>
